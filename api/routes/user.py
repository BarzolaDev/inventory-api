...
async def register_user(
    ...
    try:
        ...
        logger.info(f"Usuario registrado - email: {user_in.email}")
        return result
    except user.UserAlreadyExistsError as e:
        logger.warning(f"Intento de registro duplicado - email: {user_in.email}")
...
async def refresh_token(  
    ...
    try:
        ...
        logger.warning(f"Refresh token inválido")
